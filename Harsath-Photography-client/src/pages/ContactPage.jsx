          ...
          <div>
            ...
            <div className="mt-12">
              <div className="glass-card p-8 rounded-2xl">
                <h3 className="text-2xl font-light text-[#B8860B] mb-6">Follow Us</h3>
                <div className="w-16 h-px bg-[#B8860B] mb-6"></div>
                <div className="flex space-x-4 justify-center">
                  <a href="#" className="w-12 h-12 bg-[#B8860B]/20 rounded-full flex items-center justify-center hover:bg-[#B8860B]/30 transition-colors">
          ...
          <div className="space-y-12">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 font-light">+91 9894969187</p>
            ...
            <div className="glass-card p-8 rounded-2xl">
              ...
              <div className="space-y-4">
                <a href="tel:+919894969187" className="flex items-center space-x-3 p-4 bg-[#B8860B]/10 rounded-lg hover:bg-[#B8860B]/20 transition-colors">
                ...
                <a href="https://wa.me/919894969187" className="flex items-center space-x-3 p-4 bg-green-600/20 rounded-lg hover:bg-green-600/30 transition-colors">
