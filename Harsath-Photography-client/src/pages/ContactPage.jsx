...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen bg-animated page-bg-contact">
      ...
      <section className="relative pt-32 lg:pt-40 pb-24 lg:pb-32">
        ...
        <div className="relative max-w-7xl mx-auto px-4 text-center">
          <h1 className="text-5xl lg:text-7xl font-light tracking-wider text-white mb-6">
            Let&apos;s Create
            <span className="block text-[#B8860B]">Together</span>
          </h1>
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="w-16 h-px bg-[#B8860B] mb-6"></div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-[#1a1a1a] border border-[#B8860B]/40 rounded-lg text-white placeholder-gray-300 focus:outline-none focus:border-[#B8860B] focus:bg-[#222222] transition-all duration-300"
                  />
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 bg-[#1a1a1a] border border-[#B8860B]/40 rounded-lg text-white focus:outline-none focus:border-[#B8860B] focus:bg-[#222222] transition-all duration-300"
                  >
              ...
              <button
                type="submit"
                className="w-full bg-[#B8860B] py-3 rounded-lg font-medium text-black hover:bg-[#DAA520] transition"
              >
                Send Message
              </button>
            </form>
            ...
            <div className="mt-12">
              <div className="glass-card p-8 rounded-2xl">
                <h3 className="text-2xl font-light text-[#B8860B] mb-6 text-center">Follow Our Journey</h3>
                <div className="w-16 h-px bg-[#B8860B] mb-6 mx-auto"></div>
                  ...
                  {socialLinks.map((social, index) => {
                    ...
                    return (
                      <a
                        key={index}
                        href={social.href}
                        className={`w-14 h-14 ${social.defaultColor} ${social.hoverColor} rounded-full flex items-center justify-center text-white hover:scale-110 transition-all duration-500 shadow-lg`}
          ...
          <div className="space-y-12">
            ...
            {/* Contact Information */}
            <div className="glass-card p-8 rounded-2xl">
              <h3 className="text-3xl font-light text-[#B8860B] mb-6 tracking-wide">Get In Touch</h3>
              <div className="w-16 h-px bg-[#B8860B] mb-8"></div>
              
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-[#B8860B]/20 rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-[#B8860B] font-light text-lg mb-2">Phone</h4>
                    <p className="text-gray-300 font-light">+91 98435 35984</p>
            ...
            <div className="glass-card p-8 rounded-2xl">
              <h3 className="text-2xl font-light text-[#B8860B] mb-6">Quick Contact</h3>
              <div className="w-16 h-px bg-[#B8860B] mb-6"></div>
              <div className="space-y-4">
                <a href="tel:+919843535984" className="flex items-center space-x-3 p-4 bg-[#B8860B]/10 rounded-lg hover:bg-[#B8860B]/20 transition-colors">
                ...
                <a href="https://wa.me/919843535984" className="flex items-center space-x-3 p-4 bg-green-600/20 rounded-lg hover:bg-green-600/30 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-light tracking-wider text-white mb-6">
              Frequently Asked
              <span className="block text-[#B8860B]">Questions</span>
            </h2>
            <div className="w-24 h-px bg-[#B8860B] mx-auto mb-8"></div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {[
              ...
              <div key={index} className="glass-card p-6 rounded-xl">
                <h3 className="text-xl font-light text-[#B8860B] mb-4">{faq.question}</h3>
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-light tracking-wider text-white mb-6">
              Visit Our
              <span className="block text-[#B8860B]">Studio</span>
            </h2>
            <div className="w-24 h-px bg-[#B8860B] mx-auto mb-8"></div>
            <p className="text-lg font-light text-gray-300 max-w-2xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            <div className="glass-card p-6 text-center rounded-xl">
              ...
              <h3 className="text-xl font-light text-[#B8860B] mb-2">Professional Studio</h3>
            ...
            <div className="glass-card p-6 text-center rounded-xl">
              ...
              <h3 className="text-xl font-light text-[#B8860B] mb-2">Prime Location</h3>
            ...
            <div className="glass-card p-6 text-center rounded-xl">
              ...
              <h3 className="text-xl font-light text-[#B8860B] mb-2">Flexible Hours</h3>
      ...
      {/* Call to Action */}
      <section className="py-16 lg:py-24 bg-gradient-to-br from-[#B8860B]/10 to-black">
          ...
          <div className="glass-card p-12 rounded-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <a 
                ...
                className="bg-[#B8860B] text-black px-12 py-4 rounded-full font-light tracking-wider hover:bg-[#DAA520] transition-all duration-300 shadow-lg"
              >
                Call Now
              </a>
              <a 
                href="https://wa.me/919843535984" 
                className="bg-transparent border border-[#B8860B] text-[#B8860B] px-12 py-4 rounded-full font-light tracking-wider hover:bg-[#B8860B] hover:text-black transition-all duration-300"
              >
                WhatsApp Us
              </a>
            </div>
